...
OUTPUT_FILE = BASE_DIR / "mlo_distribution_report.txt"
...
def count_test(folder_path):
    """Patient-wise test → count only MLO.png"""
    count = 0
...
def main():
    report_lines = []
    report_lines.append("CNN_MLO_View Distribution Report")
    ...
    print("✅ MLO report saved at:", OUTPUT_FILE)
