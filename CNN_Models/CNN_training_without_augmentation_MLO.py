...
OUTPUT_DIR = r"C:\Users\USER\Desktop\CNN_TRAINING_2.0\RESULTS\MLO_without_Augmentation"
...
best_val_acc = 0
best_model_path = os.path.join(OUTPUT_DIR, "best_mlo_no_aug_model.pth")
...
plt.title("Confusion Matrix - MLO CNN No Augmentation")
...
plt.ylabel("Accuracy")
plt.legend()
plt.title("Accuracy Curve - MLO CNN No Augmentation")
...
plt.ylabel("Loss")
plt.legend()
plt.title("Loss Curve - MLO CNN No Augmentation")
