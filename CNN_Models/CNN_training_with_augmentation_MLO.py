...
# PATHS
# =========================
DATA_DIR = r"C:\Users\USER\Desktop\CNN_TRAINING_2.0\cnn_mlo_view"

TRAIN_DIR = os.path.join(DATA_DIR, "train")
VAL_DIR   = os.path.join(DATA_DIR, "val")
TEST_DIR  = os.path.join(DATA_DIR, "test")

OUTPUT_DIR = r"C:\Users\USER\Desktop\CNN_TRAINING_2.0\RESULTS\MLO_with_Augmentation"
...
best_val_acc = 0
best_model_path = os.path.join(OUTPUT_DIR, "best_mlo_aug_model.pth")
...
with open(os.path.join(OUTPUT_DIR, "final_metrics.txt"), "w") as f:
    ...
    f.write("Model: MLO CNN ResNet18\n")
    f.write("Augmentation: YES\n")
    f.write("Class weights: Benign=1.0, Malignant=1.5\n")
    f.write("Trainable layers: layer4, fc\n")
...
plt.title("Confusion Matrix - MLO CNN with Augmentation")
...
plt.ylabel("Accuracy")
plt.legend()
plt.title("Accuracy Curve - MLO CNN with Augmentation")
...
plt.ylabel("Loss")
plt.legend()
plt.title("Loss Curve - MLO CNN with Augmentation")
