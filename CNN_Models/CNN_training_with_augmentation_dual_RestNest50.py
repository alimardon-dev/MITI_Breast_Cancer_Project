...
RESULTS_DIR = "RESULTS/Dual_ResNet50_with_Augmentation"
...
class DualResNet50(nn.Module):
    def __init__(self, num_classes=2):
        ...
        self.cc_branch = models.resnet50(
            weights=models.ResNet50_Weights.IMAGENET1K_V2
        )
        self.mlo_branch = models.resnet50(
            weights=models.ResNet50_Weights.IMAGENET1K_V2
        )
        ...
        self.classifier = nn.Sequential(
            nn.Linear(cc_features + mlo_features, 512),
            nn.ReLU(),
            nn.BatchNorm1d(512),
            nn.Dropout(0.5),
        ...
        for phase in ["train", "val"]:
            ...
            if phase == "val":
                if epoch_loss < best_val_loss:
                    ...
                    torch.save(
                        model.state_dict(),
                        os.path.join(RESULTS_DIR, "best_dual_resnet50_with_aug.pth")
                    )
...
def save_confusion_matrix(labels, preds):
    ...
    plt.title("Confusion Matrix - Dual ResNet50 With Augmentation")
...
def main():
    ...
    model = DualResNet50(num_classes=2).to(DEVICE)
    ...
    with open(os.path.join(RESULTS_DIR, "classification_report.txt"), "w", encoding="utf-8") as f:
        f.write("Dual ResNet50 With Augmentation\n")
        f.write("================================\n\n")
        f.write(f"Seed: {SEED}\n")
