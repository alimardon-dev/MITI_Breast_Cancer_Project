...
OUTPUT_DIR = r"C:\Users\USER\Desktop\CNN_TRAINING_2.0\RESULTS\CC_with_Augmentation"
...
best_val_acc = 0
best_model_path = os.path.join(OUTPUT_DIR, "best_cc_aug_model.pth")
...
plt.title("Confusion Matrix - CC CNN with Augmentation")
...
plt.ylabel("Accuracy")
plt.legend()
plt.title("Accuracy Curve - CC CNN with Augmentation")
...
plt.ylabel("Loss")
plt.legend()
plt.title("Loss Curve - CC CNN with Augmentation")
