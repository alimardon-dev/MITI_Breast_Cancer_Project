...
# PATHS
# =========================
DATA_DIR = r"C:\Users\USER\Desktop\CNN_training_breast_cancer\paired_data_split"
OUTPUT_DIR = r"C:\Users\USER\Desktop\CNN_training_breast_cancer\results_dual_input_with_augmentation"
...
# LOAD DATA
# =========================
train_dataset = PairedDataset(TRAIN_DIR, train_transform)
val_dataset   = PairedDataset(VAL_DIR, val_test_transform)
test_dataset  = PairedDataset(TEST_DIR, val_test_transform)
...
plt.title("Confusion Matrix - Dual Input CNN")
...
plt.ylabel("Accuracy")
plt.legend()
plt.title("Accuracy Curve - Dual Input CNN")
...
plt.ylabel("Loss")
plt.legend()
plt.title("Loss Curve - Dual Input CNN")
