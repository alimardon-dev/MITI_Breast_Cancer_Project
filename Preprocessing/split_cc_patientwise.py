...
DST_ROOT = r"C:\Users\USER\Desktop\CNN_training_breast_cancer\cnn_data"
...
def copy_split(patient_to_files, split_name, patient_ids):
    ...
    for pid in patient_ids:
        for src_path, label, fname in patient_to_files[pid]:
            ...
            shutil.copy2(src_path, dst_path)  # NO resizing here
            count += 1
    return count


def main():
    print("Building patient-wise split (NO resizing)...")
